<div class="social__list">
    ...
    <a class="social__item text-decoration-none" href="<?=$v['link']?>">
        <div class="social-item">
            <?=$func->getImage(['class' => '', 'sizes' => '29x29x1', 'upload' => UPLOAD_PHOTO_L, 'image' => $v['photo'], 'alt' => $setting['name'.$lang]])?>
        </div>
    </a>
    <?php }}?>
</div>
    ...
    <div class="owl-page owl-carousel owl-theme" data-xsm-items="1:0" data-sm-items="1:0" data-md-items="1:0"
        ...
        <div class="slideshow-item" owl-item-animation>
            <a class="slideshow-image" href="<?=$v['link']?>" target="_blank" title="<?=$v['name'.$lang]?>">
                <?=$func->getImage(['class' => 'lazy w-100', 'sizes' => '1366x700x1', 'upload' => UPLOAD_PHOTO_L, 'image' => $v['photo'], 'alt' => $v['name'.$lang]])?>
            </a>
        </div>
        <?php } ?>
    </div>
